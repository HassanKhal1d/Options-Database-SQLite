...
The dataset is distributed as two CSV files — `SPX_minute_options_2023-10-02.csv` and `SPX_minute_options_2023-10-03.csv` — provided directly through the Quantra learner dashboard as part of the capstone project materials in the `data_modules` folder. No public repository, API, or physical media distribution has been established.
 
**When will the dataset be made available?**
 
The dataset is available to enrolled students on the Quantra platform for the duration of the capstone project. Any distribution beyond this context would require explicit approval from QuantInsti as the course provider.
